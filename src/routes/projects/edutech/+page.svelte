<script lang="ts">
  ...
  import image1 from '$lib/assets/eduTech.avif'
  ...
  export let project = {
      ...
      highlights: [
          "Revolutionary e-learning platform for K-12 students",
          "AI-driven personalized learning solutions",
          "Innovative digital learning tools",
          "Interactive platform for personalized learning experiences"
      ],
      keyFeatures: [
      ...
      about: "EduTech Platform is revolutionizing K-12 education with our AI-driven personalized learning solutions. Our innovative digital learning tools empower students to learn at their own pace and receive personalized feedback to enhance their learning experience."
  };
