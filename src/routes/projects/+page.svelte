<script lang="ts">
  ...
  export let project = {
      ...
      about: "AgriTech is revolutionizing small-scale farming with our IoT-powered precision agriculture solution. Our technology empowers farmers to make data-driven decisions, optimize resource usage, and increase their crop yields sustainably."
  };
          ...
          <div class="flex flex-wrap -mx-4">
              ...
              <div class="w-full lg:w-1/3 px-4">
                  <div class="bg-gray-100 rounded-lg p-6">
                      ...
                      <a href="/account/signup" class="w-full bg-primary text-white font-bold py-2 px-4 rounded hover:bg-indigo-600 transition-colors">
                          Invest Now
                      </a>
                  </div>
              </div>
