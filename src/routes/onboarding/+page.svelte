			...
			{:else}
				...
				{#if currentStep === 1}
					...
					<div class="text-center" in:fade={{ duration: 300 }}>
						...
						<div class="grid grid-cols-1 md:grid-cols-2 gap-6">
							...
							>
								<div
									class="h-12 w-12 mx-auto mb-4 rounded-full bg-indigo-100 flex items-center justify-center group-hover:bg-indigo-200 transition-colors"
								>
									...
									<p class="mt-1 text-sm text-gray-500">
										...
										<span class="text-indigo-600 font-medium">
											{startupData.description
												? `${startupData.description.length}/50 characters`
												: '0/50 characters'}
										</span>
									</p>
								</div>
				...
				{:else if currentStep === 5}
					...
					<div class="text-center" in:fade={{ duration: 400 }}>
						<div
							class="mx-auto flex items-center justify-center h-24 w-24 rounded-full bg-green-100 mb-8"
						>
							<svg
							...
							>
								<path
									...
									stroke-width="2"
									d="M20 6L9 17l-5-5m18 14l8-8L43 31l-5 5L26 24l-8 8-9-9 8-8 3 3z"
								/>
							</svg>
						</div>
						...
						<p class="text-gray-500 mb-8">Redirecting you to your dashboard in a moment...</p>
